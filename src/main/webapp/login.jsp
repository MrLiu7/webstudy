...
<head>
    ...
    <script type="text/javascript">
        var refreshCode = function () {
            ...
            codeImg.src = "${pageContext.request.contextPath}/verCodeServlet?" + new Date().getTime();
        }
    </script>
</head>
<body>
    ...
    <form action="${pageContext.request.contextPath}/loginServlet" method="post">
        ...
        <div class="form-inline">
            ...
            <a href="javascript:refreshCode();">
                <img src="${pageContext.request.contextPath}/verCodeServlet" title="看不清点击刷新" id="vcode"/>
            </a>
        </div>
        <hr/>
